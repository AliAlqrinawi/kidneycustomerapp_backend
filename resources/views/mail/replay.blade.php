                        ...
                        <tr>
                            <td style="font-family: sans-serif; font-size: 14px; vertical-align: top;" valign="top">
                                <table border="0" cellpadding="0" cellspacing="0" class="alert alert-success"
                                    ...
                                    <tr>
                                        <td align="center"
                                            style="font-family: sans-serif; vertical-align: top; font-size: 16px; border-radius: 3px 3px 0 0; color: #ffffff; font-weight: 500; padding: 20px; text-align: center; background-color:  #154572;"
                                            valign="top" bgcolor=" #de5698">
                                            {{ @$header_text }}
                                        </td>
                                    </tr>
                                </table>
                                ...
                                <table border="0" cellpadding="0" cellspacing="0"
                                    ...
                                    <tr>
                                        <td style="font-family: sans-serif; font-size: 14px; vertical-align: top;"
                                            valign="top">
                                            {{--<p
                                                style="font-family: sans-serif;text-align: right;  font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;">
                                                {{$title}} </p>--}}
                                            <p
                                                style="font-family: sans-serif; font-size: 14px;text-align: right;  font-weight: normal; margin: 0; Margin-bottom: 15px;">
                                                {!! $content !!} </p>
                                        </td>
                                    </tr>
                                </table>
