...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
   @php 
            $title_toolbar = __('dashboard.posts');
   $toolbar_links = [
      [
                  ...
                  <div class="fv-row mb-7">
                     ...
                     <div class="image-input image-input-outline" data-kt-image-input="true"
                        ...
                        <label class="btn btn-icon btn-circle btn-active-color-primary w-25px h-25px bg-white shadow "
                           ...
                           <input type="hidden" id="custome_path" value="posts" />
               ...
               selected="selected" @endif>
                  ...
                  <div class="fv-row mb-7 fv-plugins-icon-container">
                     ...
                     <label class="fs-6 fw-bold mb-2">
                        {{__('dashboard.video_link')}}
                     </label>
                     <!--end::Label-->
                     <!--begin::Input-->
                     <input type="text" name="video_link" class="form-control form-control-solid"
                        value="{{isset($item) ? @$item->video_link : ''}}"  id="video_link" placeholder="" />
                     <!--end::Input-->
