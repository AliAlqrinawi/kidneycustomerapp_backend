         ...
         <div class="card">
            ...
            <div class="card-header">
               ...
               <div class="card-toolbar">
                  <a href="{{route('panel.products.create.index')}}" class="btn btn-sm btn-primary">
...
@push('panel_js')
   ...
   <script>
      window.data_url = '{{route('panel.products.all.data')}}';
      window.columns = [
        {
          data: 'id', name: 'id'
        },
        ...
        },
        {
          ...
          title: '{{__('dashboard.quantity_available')}}',
        },
        {
          data: 'action',
