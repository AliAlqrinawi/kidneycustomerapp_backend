...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
   @php 
        $title_toolbar = __('dashboard.admins');
   $toolbar_links = [
      [
            ...
            <form id="form" method="{{isset($item) ? 'POST' : 'POST'}}" to="{{url()->current()}}"
               ...
               <div class="card-body">
                  ...
                  <div class="fv-row mb-7 fv-plugins-icon-container">
                     ...
                     <!--end::Label-->
                     <!--begin::Input-->
                     <input type="text" name="email" class="form-control form-control-solid" value="{{@$item->email}}"
                        required id="exampleInputPassword1" placeholder="" />
                     <!--end::Input-->
                     <div class="fv-plugins-message-container invalid-feedback"></div>
                  </div>
                  ...
                  <div class="fv-row mb-10">
                     ...
                     <!--end::Label-->
                     <!--begin::Input-->
                     <select name="role_id" data-control="select2" data-placeholder="{{__('dashboard.roles')}}"
                        data-hide-search="true" class="form-select form-select-solid fw-bolder" required>
                        <option></option>
                  ...
                  <div class="fv-row mb-7 fv-plugins-icon-container">
                     ...
                     <!--end::Label-->
                     <!--begin::Input-->
                     <input type="password" name="password" class="form-control form-control-solid" value=""
                        id="exampleInputPassword1" placeholder="" @if(!isset($item)) required @endif />
                     <!--end::Input-->
                     @if(!isset($item))
                   <div class="form-text">
