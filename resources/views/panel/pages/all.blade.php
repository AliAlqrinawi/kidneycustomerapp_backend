...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
   @php 
         $title_toolbar = __('dashboard.pages');
   $toolbar_links = [
      [
         ...
         <div class="card">
            ...
            <div class="card-header">
               ...
               <div class="card-toolbar">
                  <a href="{{route('panel.pages.create.index')}}" class="btn btn-sm btn-primary">
...
@push('panel_js')
   ...
   <script>
      window.data_url = '{{route('panel.pages.all.data')}}';
      window.columns = [
        {
          data: 'id', name: 'id'
        },
