                        ...
                        <div class="card-body">
                            <div class="fv-row mb-7">
                                ...
                                <div class="image-input image-input-outline" data-kt-image-input="true"
                                    ...
                                    <label
                                        ...
                                        <input type="hidden" id="custome_path" value="users" />
                            ...
                            <div class="fv-row mb-7 fv-plugins-icon-container">
                                ...
                                <input type="text" name="email" class="form-control form-control-solid"
                                    value="{{ @$item->email }}" required id="exampleInputPassword1" data-placeholder="{{__('dashboard.roles')}}" />
                                <!--end::Input-->
                                <div class="fv-plugins-message-container invalid-feedback"></div>
                            </div>

                            <div class="fv-row mb-7 fv-plugins-icon-container" {{ Auth::guard('admin')->user()->hasRole("admins") ? "" : "hidden" }}>
                                <!--begin::Label-->
                                ...
                                data-placeholder="{{__('dashboard.select_an_institution')}}">
                                    ...
                                    <option value="{{ $institutionData->id }}" {{ @$item->institution_id == $institutionData->id ? "selected" : "" }} {{ $institutionId == $institutionData->id ? "selected" : "" }}>{{ $institutionData->name }}</option>
                                    @endforeach
                                </select>
                                <!--end::Input-->
                            </div>
