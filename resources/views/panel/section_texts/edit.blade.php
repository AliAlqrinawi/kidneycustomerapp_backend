@extends('panel.layouts.index', [
   'sub_title' => __('dashboard.' . request('section')),
   'is_active' => 'section_text_' . request('section')
])
@section('contion')
<!--begin::Content-->
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
   @php 
   $title_toolbar = __('dashboard.' . request('section'));
   $toolbar_links = [
      [
      ...
      [
        'title' => __('dashboard.pages_wallpapers'),
        'link' => '#'
      ],
      [
        'title' => __('dashboard.' . request('section')),
        'link' => '#'
      ],
   ];
   @endphp
                  ...
                  <div class="fv-row mb-7">
                     ...
                     <div class="image-input image-input-outline" data-kt-image-input="true"
                        ...
                        <label class="btn btn-icon btn-circle btn-active-color-primary w-25px h-25px bg-white shadow "
                           ...
                           <input type="hidden" id="custome_path" value="{{request('section')}}" />
