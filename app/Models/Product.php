...
class Product extends Model
{
    ...
    use SoftDeletes;
    use Translatable;
    protected $fillable = ['image', 'category_id', 'is_active', 'price', 'quantity_available'];
    ...
    {
        return $this->hasOne('App\Models\Constant', 'value', 'category_id')
            ->where('parent', 'products_categories');
    }
