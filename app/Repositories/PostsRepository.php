...
class PostsRepository
{
    ...
    public function getMostRead()
    {
        ...
        $most_read_posts = $post->orderBy('num_views', 'desc')->take(4)->get();
    ...
    public function getByPaginate($request)
    {
        ...
        $data['items'] = PostResource::collection($items);
    ...
    {
        $data = Post::select("id", "num_views")
            ->with('translations:post_id,title,locale')
            ->orderByDesc("created_at")
            ->latest();
        return Datatables::of($data)
            ...
            ->addColumn("action", function ($item) {
                $return =
                    '<a href="' . route("panel.posts.edit.index", ["id" => $item->id]) . '"
                ...
                $return .= '
                                ...
                                data-url="' . route("panel.posts.delete", ["id" => $item->id]) . '"
    ...
    public function store($request)
    {
        ...
        Post::updateOrCreate(['id' => 0], $request->all())->createTranslation($request);
    ...
    {
        Post::updateOrCreate(['id' => $id], $request->all())->createTranslation($request);
